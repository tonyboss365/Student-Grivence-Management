  ...
  return (
    <div className={`flex flex-col items-start ${className}`}>
      <div className="w-full h-full min-w-max flex items-center justify-start">
        <svg viewBox="0 0 100 120" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 lg:w-12 lg:h-12 text-[#6B6B66] dark:text-[#A1A1AA] transition-colors duration-300">
          {/* Document Base */}
      ...
      <span className="mt-2 font-sans font-bold tracking-[0.2em] text-[10px] text-[#111110] dark:text-[#FDFCF8] transition-colors duration-300 whitespace-nowrap">GRIEVANCE</span>
    </div>
  );
}
