  ...
  return (
    <div className="min-h-screen flex text-[#111110] dark:text-[#FDFCF8] relative overflow-hidden bg-[#FDFCF8] dark:bg-[#111110] transition-colors duration-300">
        ...
        <div className="max-w-xl space-y-12 h-[calc(100vh-200px)] overflow-y-auto custom-scrollbar pr-6">
          <div className="mb-12">
            ...
            <h1 className="font-serif text-6xl leading-[1.1] tracking-tight mb-8 text-[#111110] dark:text-[#FDFCF8]">
              <TextReveal text="Join the community." />
            </h1>
            <motion.p 
            ...
            >
              Create an account to submit grievances, track their progress, and help us improve the institution.
            </motion.p>
          </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative z-10">
        ...
        >
          <h2 className="text-3xl font-serif mb-2 tracking-tight">Create account</h2>
          <p className="text-[#6B6B66] dark:text-[#A1A1AA] mb-8">Enter your details to get started.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-sm font-medium mb-2 text-[#555550] dark:text-[#A1A1AA]">Full Name</label>
              <Input
                type="text"
                required
                value={name}
          ...
          <p className="mt-8 text-center text-sm text-[#6B6B66] dark:text-[#A1A1AA]">
            ...
            <Link to="/login" className="text-[#111110] dark:text-[#FDFCF8] font-medium hover:underline underline-offset-4">
              Sign in
            </Link>
          </p>
        </motion.div>
